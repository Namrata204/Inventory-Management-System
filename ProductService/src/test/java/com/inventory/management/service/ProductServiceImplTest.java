...
class ProductServiceImplTest {
     ...
     * Should successfully update the stock quantity.
     */
    @Test
    void updateStockQuantity_ExistingProduct_SuccessfullyUpdatesStockQuantity() {
        // Arrange
        ...
        // Act
        assertDoesNotThrow(() -> productService.updateStockQuantity(productName, quantity));

        // Assert
        assertEquals(45, existingProduct.getQuantity());
     ...
     * Should throw a ProductNotFoundException.
     */
    @Test
    void updateStockQuantity_NonexistentProduct_ThrowsProductNotFoundException() {
        ...
        // Act & Assert
        assertThrows(ProductNotFoundException.class, () -> productService.updateStockQuantity(productName, quantity));
